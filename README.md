...
`Wait 'int milisekundy'` Na przykład `Wait 2000` Czeka przez dwie sekundy. <br>
...
`run` Uruchamia program po jego kompilacji. Uwaga. Ta flaga może nie zawsze przynosić pożądane efekty. Zawsze lepiej jest uruchomić program ręcznie. <br> <br>
